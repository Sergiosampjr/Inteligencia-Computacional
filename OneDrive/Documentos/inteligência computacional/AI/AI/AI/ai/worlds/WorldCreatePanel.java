...
public class WorldCreatePanel extends JPanel implements ActionListener, ItemListener {
     ...
     */
    String[] vacuumStrings = {"Random Vacuum Agent", "Reactive Vacuum Agent","AgenteReativoSimplesVacuumAgent", "AgenteBaseadoEmModeloVacuumAgent","SergioVacuumAgent"};
    /**
    ...
    private Agent createAgent(String agentName) {
    	...
    	else if (agentName == "AgenteReativoSimplesVacuumAgent") return new AgenteReativoSimplesVacuumAgent();
		else if (agentName == "AgenteBaseadoEmModeloVacuumAgent") return new AgenteBaseadoEmModeloVacuumAgent();
		else if (agentName == "SergioVacuumAgent") return new SergioVacuumAgent();
