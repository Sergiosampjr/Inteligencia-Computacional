...
public class WorldCreatePanel extends JPanel implements ActionListener, ItemListener {
     ...
     */
    String[] vacuumStrings = {"Random Vacuum Agent", "Reactive Vacuum Agent","ai.worlds.vacuum.MeuAgenteReativoSimplesVacuumAgent", "ai.worlds.vacuum.MeuAgenteModeloVacuumAgent"};
    /**
	...
	private Agent createAgent(String agentName) {
		...
		else if (agentName.equals("MeuAgenteReativoSimplesVacuumAgent")) { //Seu agente
			return new MeuAgenteReativoSimplesVacuumAgent();
		} else if (agentName.equals("MeuAgenteModeloVacuumAgent")) { //Seu agente
			return new MeuAgenteModeloVacuumAgent();
		} else {
